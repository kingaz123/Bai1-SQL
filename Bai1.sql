...
SELECT COUNT(u.user_id) AS number_of_likes, u.full_name 
FROM like_res AS lr
...
SELECT COUNT(r.res_id) AS number_of_likes, r.res_name 
FROM like_res AS lr
...
SELECT COUNT(o.user_id) AS number_of_orders, u.full_name 
FROM users AS u
